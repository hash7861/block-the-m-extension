...
5. Select the project folder and pin the tool to see it in action
...
📦 Installation (Non-CS crowd)

If this is too hard to follow, simply download the zip in a place that you will remember, extract the files, and then follow the same steps as above.